...
## Project context
- Project: autonomous patrol quadricycle with Ackermann steering
...
## Paths
- Host workspace: `/home/leo/codigo/aeye-ros-workspace`
...
## Repository caveats
- `src/*` are nested git repositories; inspect git status per package.
